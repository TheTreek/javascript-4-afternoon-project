...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  // Once the User constructor function is created, write a prototype method for the User function. Name this method addSavedPost. It should take in three parameters: 
  //id (a number), title (a string) and rating (a number). Use these parameters to create a new object and add it to the savedPosts array. 
...
User.prototype.addSavedPost = function(id,title,rating){
  ...
  User.prototype.removeSavedPost = function(id){
    let obj = this.savedPosts.find(x => x.id=== id);
    let i = this.savedPosts.indexOf(obj);
